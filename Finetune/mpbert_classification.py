...
from src.bert_for_finetune import BertFinetuneCell, BertCLS,BertCLSEval,EarlyStoppingSaveBest
...
def sensitivity(Y_test,Y_pred,n=2):
    sen = []
...
def do_predict(seq_len=1024, network=None, num_class=2, load_checkpoint_path="",tokenizer=None):
    ...
    for data in ds_predict:
        input_ids, input_mask, token_type_id, label_ids,id,truncate_token_a=generate_predict_seq(predict_format,data,tokenizer,seq_len)
