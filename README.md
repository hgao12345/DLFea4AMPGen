...
**If you are generating single-activity peptides, you can skip this normalization step**. Normalize SHAP values across multiple models to mitigate differences in magnitude, enabling fair comparison or integration:
```
...
- `--input_file <example_data.csv>`: CSV file containing PCA clustering results generated by iFeature.
